...
conn.on('ready', async () => {
    ...
    try {
        ...
        console.log('\n✅ DEPLOY v3.8.179 COMPLETO!');
        console.log('📋 Mudanças: v3.8.177 injectou \\n\\n com SyntaxError. v3.8.178 reverteu para \\\\n\\\\n mas não escapou template literal. v3.8.179: \\\\\\\\n\\\\\\\\n no template = \\\\n\\\\n no runtime = newline real no STOMP, sem SyntaxError.');
