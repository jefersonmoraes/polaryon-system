...
conn.on('ready', async () => {
    ...
    try {
        ...
        console.log('📋 Mudanças: bid-in-progress mutex (RoomRunner checa antes de disparar), log JSON resposta Serpro no 422, lock limpo via try/finally');
