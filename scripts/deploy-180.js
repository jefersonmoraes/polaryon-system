...
conn.on('ready', async () => {
    ...
    try {
        ...
        console.log('\n✅ DEPLOY v3.8.180 COMPLETO!');
        console.log('📋 Mudanças: v3.8.179 quebrou injected script: \\n e \\0 em COMENTÁRIOS viram newline real e null byte → SyntaxError. v3.8.180: comentários usam \\\\n e \\\\0 corretamente.');
