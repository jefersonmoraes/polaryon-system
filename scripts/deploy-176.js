...
conn.on('ready', async () => {
    ...
    try {
        ...
        console.log('📋 Mudanças: WS como fonte PRIMÁRIA de dados (não limpa realtimeItems após uso), TTL aumentado de 2s para 5s, HTTP vira fallback real');
