...
conn.on('ready', async () => {
    ...
    try {
        ...
        console.log('📤 Enviando EXE do desktop (se existir)...');
        ...
        console.log('\n✅ DEPLOY v3.8.173 COMPLETO!');
        console.log('📋 Mudanças: cooldown mínimo 1000ms entre lances (evita 422), frontend percent margin usa currentBest, dedup temporal em sendBid(), notifyBidSent do manual-bid, logs diagnóstico');
