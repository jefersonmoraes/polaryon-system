...
conn.on('ready', async () => {
    ...
    try {
        ...
        console.log('📋 Mudanças: frontend sniper desligado quando backend ativo (elimina dual-engine), cooldown 1000/1500→500/1000ms, backendActive flag');
