...
import { FolderOpen, Plus, ChevronRight, ChevronLeft, LayoutGrid, Calendar, Users, Building2, Truck, Briefcase, MapPin, Calculator, FileText, PiggyBank, LayoutDashboard, FileBarChart, ArrowLeftRight, Activity, ShieldAlert, Target, Trash2, Star, MoreVertical, Edit2, FolderPlus, Zap, TrendingUp, Radar, MonitorDown, Monitor, Shield, Terminal } from 'lucide-react';
        ...
        {isElectron && (
          <div className="px-3 py-4 border-t border-white/5 bg-slate-900/40">
            ...
            >
              ...
              {!isCollapsed && <div className="ml-auto bg-green-500 text-[8px] px-1 rounded-sm text-white font-bold animate-pulse">V2.1.6 HYBRID-DIRECT</div>}
            </Link>
          </div>
        )}
