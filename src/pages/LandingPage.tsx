      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ${scrolled ? 'bg-black/80 backdrop-blur-md py-4' : 'bg-transparent py-8'}`}>
        <div className="max-w-[1800px] mx-auto px-10 flex justify-between items-center text-xs font-bold tracking-[0.2em] uppercase">
          ...
          <div className="flex items-center gap-8">
            <a href="#services" className="hover:text-blue-500 transition-colors">Portfólio</a>
        ...
        <div className="max-w-[1800px] mx-auto flex flex-col md:flex-row justify-between items-start gap-12">
          ...
          <div className="flex flex-col gap-4 text-xs font-bold uppercase tracking-widest">
            ...
            <div className="flex flex-col gap-4">
              <h3 className="text-xs font-bold uppercase tracking-widest text-white/40">Suporte</h3>
              <a href="mailto:contato@polaryon.com.br" className="text-xs font-medium hover:text-blue-500 transition-colors">contato@polaryon.com.br</a>
              <Link to="/login" className="text-[10px] font-bold uppercase tracking-[0.3em] text-white/10 hover:text-blue-600 transition-all mt-4 border border-white/5 py-2 px-4 rounded-lg inline-block w-fit">
                Área Restrita
              </Link>
            </div>
